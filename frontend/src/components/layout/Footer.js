        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              Access notes, practice tests, and connect with peers to excel in your studies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/content" className="text-gray-300 hover:text-white transition-colors">
                  Study Materials
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@coursehive.com</span>
              </div>
              <div className="flex items-center space-x-3">
